...
summary: 'This project is a custom-built wedding photo sharing app, created for a friend’s wedding. Guests scanned QR codes at their tables to instantly upload photos, resulting in 91 memories from 212 visitors with zero downtime.'
link: 'ayserenas.dk'
